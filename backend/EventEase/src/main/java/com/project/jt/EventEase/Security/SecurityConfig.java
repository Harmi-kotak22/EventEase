    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(configurer -> configurer
                        ...
                        .requestMatchers("/auth/register").permitAll()  // Added registration endpoint
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/registrations/**").hasRole("CLUB_ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/registrations").hasAnyRole("CLUB_ADMIN", "STUDENT")
                        .requestMatchers(HttpMethod.POST, "/registrations").hasAnyRole("CLUB_ADMIN", "STUDENT")
                        ...
                        .requestMatchers(HttpMethod.GET, "/comments/**").hasAnyRole("STUDENT", "CLUB_ADMIN")
                        .requestMatchers(HttpMethod.POST, "/comments/**").hasAnyRole("CLUB_ADMIN","STUDENT")
